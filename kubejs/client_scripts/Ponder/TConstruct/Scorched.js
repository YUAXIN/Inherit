Ponder.registry(e => {
	e.create('tconstruct:foundry_controller')
		.scene('kubejs:scorched', '熔铸炉', 'kubejs:scorched', scene => {
			...
			scene.text(20, '§b熔铸炉控制器', [4.5, 2.5, 2]).placeNearTarget()
			scene.idle(30)
			// 燃料储罐
			scene.overlay.showOutline('red', {}, [3, 2, 2], 30)
			scene.text(20, '§b燃料储罐', [3.5, 2.5, 2]).placeNearTarget()
			scene.idle(30)
			// 排液口
			scene.overlay.showOutline('red', {}, [2, 2, 2], 30)
			scene.text(20, '§b焦褐排液口', [2.5, 2.5, 2]).placeNearTarget()
			scene.idle(30)
